...
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT_V5         = 500;
...
const uint32_t UPGRADE_HEIGHT_V5                                = 1860;
...
const int      P2P_DEFAULT_PORT                              =  15020;
const int      RPC_DEFAULT_PORT                              =  15021;
