                   ...
                   CryptoNote::INode &node)
{
    ...
    {
        transfer(walletInfo, node.getLastKnownBlockHeight(), false, std::string(), 0);
    ...
    {
        sendFromAddressBook(walletInfo, node.getLastKnownBlockHeight(), std::string(), 0);
                            //node.feeAddress(), node.feeAmount());
    }
    ...
    {
        transfer(walletInfo, node.getLastKnownBlockHeight(), true, std::string(), 0);
                 //node.feeAddress(), node.feeAmount());
    }
