...
namespace
{
  ...
  const command_line::arg_descriptor<std::vector<std::string>> arg_genesis_block_reward_address = { "genesis-block-reward-address", CryptoNote::parameters::GENESIS_BLOCK_REWARD_ADDRESS};
